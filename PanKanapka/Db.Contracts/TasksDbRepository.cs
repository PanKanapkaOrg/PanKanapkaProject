...
namespace Db.Contracts
{
    public class TasksDbRepository : ITasksRepository
    {
        ...
        public System.Threading.Tasks.Task DeleteTasks(IEnumerable<long> taskIds)
        {
        ...
        {
            string getTaskSqlQuery = "select w.ID as WorkerId, w.name as WorkerName, w.surname as WorkerSurname, t.taskDate as TaskDate, cf.logoUrl as LogoUrl," +
